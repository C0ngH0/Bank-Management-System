//Author:	 : Cong Ho
//Date		 : May 15th, 2022
//Description: Implemented composition, inheritance, copy constructors, 
//			   function objects, exception objects etc.
#ifndef Bank_h
#define Bank_h
#include <vector>
#include<memory>
...
public:
	...
	bool checkDiff(Bank& other);
	//bool withdrawExistedAccount(int a, double amount);
